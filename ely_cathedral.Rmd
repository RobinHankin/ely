...
$n_\mathrm{max}=-\log(1-x)^{-1}\simeq 8334$ and we can plot a support
curve:
...
The two approaches give similar likelihood ratios for small $x$, for
$-\log(1-x)^{-1}=\frac{1}{x} + \frac{1}{2} + {\mathcal O}(x)$.
