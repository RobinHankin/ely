...
```{r fig.cap="Diagrammatic representation of Ely Cathedral (EC), Little Ouse (LO), and Robin Hankin (RH); triangle fattened for clarity",out.width="50%"}
knitr::include_graphics("EC_LO_RH.png")
```

Above we see the three points, together with lines joining them,
forming almost a perfect straight line.


Now the latitude and
...
then usign the default value from WGS-84:
...
reject our null.  But what inference can we draw from this?
